...
`;
exports.generateCar = functions.https.onCall(async (data, context) => {
    // Authentication requirement could be added here if needed
    // if (!context.auth) {
    ...
    if (!text || typeof text !== "string") {
        throw new functions.https.HttpsError("invalid-argument", "The string argument 'text' is required.");
    }
    try {
        ...
        throw new functions.https.HttpsError("internal", "Failed to generate CAR content.");
    }
});
